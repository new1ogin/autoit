...
Func _GuiCreae()
	...
	GUICtrlSetTip($Label12, "Слежение за папкой на предмет начала или конеца изменений в папке, появления/исчезновения файла(ов), изменение даты модификации файла(ов)")
