...
$ClipPFfix = StringRegExpReplace($ClipPF,'Скрыть исполненные/отмененные поручения', 'Номер:'&@CRLF&'Скрыть исполненные/отмененные поручения')
...
;~ 	$infpor10 = StringRegExpReplace($infpor9, "(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)", "$3\tСумма поручения\t$5\t\t\t\t$2\t$1\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t$4\t$7\t$8\t\t\t$6", 1)
	$infpor10 = StringRegExpReplace($infpor9, "(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)", "$3"& @Tab &"Сумма поручения"& @Tab &"$5"& @Tab &""& @Tab &""& @Tab &""& @Tab &"$2"& @Tab &"$1"& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &$name10& @Tab &$name11& @Tab &$name9& @Tab &$name7& @Tab &$name8& @Tab &$name6& @Tab &"$7"& @Tab &"$8"& @Tab &$name1& @Tab &$name2& @Tab &$name0& @Tab &$name4& @Tab &$name5& @Tab &$name3, 1)
	...
	;Помещаем найденной в буффер обмена
ClipPut($infpor10_2)
...
;~ 	$infpor10 = StringRegExpReplace($infpor9, "(.*)"&@CRLF&"(.*)"&@CRLF&"(.*)"&@CRLF&"(.*)"&@CRLF&"(.*)"&@CRLF&"(.*)"&@CRLF&"(.*)"&@CRLF&"(.*)"&@CRLF&, "$3\tСумма поручения\t$5\t\t\t\t$2\t$1\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t$4\t$7\t$8\t\t\t$6", 1)
;~ 	$infpor10 = StringRegExpReplace($infpor9, "(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)", "$3\tСумма поручения\t$5\t\t\t\t$2\t$1\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t$4\t$7\t$8\t\t\t$6", 1)
	$infpor10 = StringRegExpReplace($infpor9, "(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)\r\n(.*)", "$3"& @Tab &"Сумма поручения"& @Tab &"$5"& @Tab &""& @Tab &""& @Tab &""& @Tab &"$2"& @Tab &"$1"& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &""& @Tab &"$4"& @Tab &"$7"& @Tab &"$8"& @Tab &""& @Tab &""& @Tab &"$6", 1)
